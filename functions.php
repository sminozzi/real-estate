...
define('realestaterightnowTHEMEURL', esc_url(get_template_directory_uri()));
...
function realestaterightnow_dashboard_help()
{
    ...
    echo '<a target="blank" href="https://realestatetheme.eu">';
    ...
    $bd_msg .= '&nbsp;&nbsp;&nbsp;';
   // https://boatplugin.com/wp-content/themes/real-estate-right-now/wp-admin/themes.php?page=real_estate
   // https://boatplugin.com/wp-admin/themes.php?page=real_estate  
    


   $url = admin_url('customize.php?return=%2Fwp-admin%2Fthemes.php%3Fpage%3Dreal_estate');
   $bd_msg .= '<a class="button button-primary" href="'.esc_url($url).'"> Theme Help</a>';
   ...
   //     '/wp-admin/themes.php?page=real_estate" class="button button-primary">Theme Help</a>';
        ...
        $bd_msg .= '&nbsp;&nbsp;&nbsp;';
    $bd_url = '  <a class="button button-primary" target="blank" href="https://realestatetheme.eu">Visit Our Site</a>';
    $bd_msg .= $bd_url;
    $bd_msg .= '&nbsp;&nbsp;&nbsp;';
    $bd_url = '<a class="button button-primary" target="blank" href="https://realestatetheme.eu/help/index.html">OnLine Guide</a>';
    $bd_msg .= $bd_url;
...
function realestaterightnow_admin_notice()
{
    ...
    $url = admin_url('customize.php?return=%2Fwp-admin%2Fthemes.php%3Fpage%3Dreal_estate');
    $bd_url = '<a class="button button-primary" href="'.esc_url($url).'"> or click here</a>';
...
if (is_admin()) {
    ...
    */
	...
	require_once (realestaterightnowTHEMEPATH . '/inc/health.php');
    ...
    function realestaterightnow_memory_notice()
    {
        ...
        $url = admin_url('themes.php?page=real_estate&tab=memory');
        
        $bd_url = '<a class="button button-primary" href="'.esc_url($url).'"> or click here</a>';
    
        //$url = admin_url('themes.php?page=real_estate&tab=dashboard');
...
'import_file_url'            => 'https://www.realestatetheme.eu/demo/demo-content.xml',
'import_widget_file_url'     => 'https://www.realestatetheme.eu/demo/widgets.json',
'import_customizer_file_url' => 'https://www.realestatetheme.eu/demo/customizer.dat',
