...
?>
      ...
      <?php
        if($activated == '1' )
        {
           echo '<img alt="aux" id="connect_status" src="'.esc_url(get_template_directory_uri()).'/images/pluggedx64.png" />';
        ...
        {
             echo '<img alt="aux" id="connect_status" src="'.esc_url(get_template_directory_uri()).'/images/unpluggedx64.png" />';
   ...
   <div id="realestaterightnow-steps3">
       <div class="realestaterightnow-block-title"> 
           <img alt="aux" src="<?php echo esc_url(get_template_directory_uri())?>/images/3steps.png" />
           <br />   <br />
    ...
    <div class="realestaterightnow-help-container1">
        ...
        <img alt="aux" src="<?php echo esc_url(get_template_directory_uri())?>/images/step1.png" />
        ...
        <div class="realestaterightnow-help-column realestaterightnow-help-column-2">
            <img alt="aux" src="<?php echo esc_url(get_template_directory_uri())?>/images/step2.png" />
       ...
       <div class="realestaterightnow-help-column realestaterightnow-help-column-3">
            <img alt="aux" src="<?php echo esc_url(get_template_directory_uri())?>/images/step3.png" />
            ...
            $url = admin_url('customize.php?return=%2Fwp-admin%2Fthemes.php%3Fpage%3Dreal_estate');
            ?>
            <a href="<?php echo esc_url($url);?>" class="button button-primary">Theme Management</a>
   ...
   <div id="realestaterightnow-services3">
    ...
    <div class="realestaterightnow-help-container1">
        <div class="realestaterightnow-help-column realestaterightnow-help-column-1">
           <img alt="aux" src="<?php echo esc_url(get_template_directory_uri())?>/images/support.png" />
          <h3>Help and more tips</h3>
          Just click the HELP button at top right corner this page.
          <br /><br />
          <?php 
          $billurl ='https://billminozzi.com'; ?> 
          <a href="<?php echo $billurl;?>/dove" class="button button-primary">Support</a>
          <br /><br />
       </div> <!-- "Column1">  -->   
        <div class="realestaterightnow-help-column realestaterightnow-help-column-2">
            <img alt="aux" src="<?php echo esc_url(get_template_directory_uri())?>/images/service_configuration.png" />
          ...
          <br /><br />
          <?php 
          $site = 'https://realestatetheme.eu'; ?> 
         <a href="<?php echo $site;?>" class="button button-primary">Go</a>
         
         &nbsp;&nbsp;&nbsp;&nbsp;
                  <a href="https://siterightaway.net/real-estate-premium-theme/" style="background:red" class="button button-primary">Upgrade to Premium</a>
       ...
       <div class="realestaterightnow-help-column realestaterightnow-help-column-3">
          ...
          <img alt="aux" src="<?php echo esc_url(get_template_directory_uri()) ?>/images/system_health.png" />
