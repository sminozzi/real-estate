...
echo '<div id="realestaterightnow-memory-page">';

        
echo '<div class="realestaterightnow-block-title">'; 
echo 'Memory Info';
echo '</div>';
...
<br /><br /><strong>Increase the WP Memory Limit is a standard practice in 

WordPress</strong> and you find instructions also in the official 
